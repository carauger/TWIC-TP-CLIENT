...
<body>
	...
	<div>
		<div>
		<label for="codeCommune">Code de la commune : </label> 
		...
		<input type="text" name="libelleAchem" id="libelleAchem" required><br>
		</div>
		<div>
		<label for="ligne5">Ligne 5 : </label> 
		<input type="text" name="ligne5" id="ligne5" required><br>
		</div>
		<div>
